...
auto get_vertices_3_out(Finite_cells_iterator const cell, ConvexHull const &CH,
    ...
    Point const ip1 = get_intersection_point(Segment(p_in_0, p_out_1), CH);
    Point const ip2 = get_intersection_point(Segment(p_in_0, p_out_2), CH);
    Point const ip3 = get_intersection_point(Segment(p_in_0, p_out_3), CH);
...
auto get_vertices_2_out(Finite_cells_iterator const cell, ConvexHull const &CH,
    ...
    Point const ip1 = get_intersection_point(Segment(p_in_0, p_out_2), CH);
    Point const ip2 = get_intersection_point(Segment(p_in_0, p_out_3), CH);
    Point const ip3 = get_intersection_point(Segment(p_in_1, p_out_2), CH);
    Point const ip4 = get_intersection_point(Segment(p_in_1, p_out_3), CH);
...
auto get_vertices_1_out(Finite_cells_iterator const cell, ConvexHull const &CH,
    ...
    Point const ip1 = get_intersection_point(Segment(p_in_0, p_out_3), CH);
    Point const ip2 = get_intersection_point(Segment(p_in_1, p_out_3), CH);
    Point const ip3 = get_intersection_point(Segment(p_in_2, p_out_3), CH);
